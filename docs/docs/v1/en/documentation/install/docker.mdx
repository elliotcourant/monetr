...
import { Callout } from '@monetr/docs/components/nextra-compat/Callout'
import { Steps } from '@monetr/docs/components/nextra-compat/Steps'
...
```yaml {2-3} title="docker-compose.yaml"
    command:
      - -c
...
```yaml {5} title="docker-compose.yaml"
services:
  # ...
  monetr:
    # ...
