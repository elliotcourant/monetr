...
This will compile the documentation and output to `$PWD/docs/doc_build`.

If you want you can then preview the built site using `pnpm --filter @monetr/docs preview`.
